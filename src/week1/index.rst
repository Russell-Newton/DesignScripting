...
This course uses Python 3 inside Rhino 8 and Grasshopper. In Python, programs are
created by chaining together statements in order to achieve a desired effect.
...
Comments in Python are preceded by a ``#`` symbol. Comments can either be on their
own line or at the end of another line. Anything after the ``#`` will be ignored when
